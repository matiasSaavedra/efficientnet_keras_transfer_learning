...
def _get_model_by_name(path, model_name='efficientnet-b0', input_shape=None, include_top=False, weights='imagenet', classes=1000, pooling='max'):
...
def EfficientNetB0(path, include_top=False, input_shape=None, weights='imagenet', classes=1000, pooling='max'):
    return _get_model_by_name(path, 'efficientnet-b0', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, pooling=pooling)

def EfficientNetB1(path, include_top=False, input_shape=None, weights='imagenet', classes=1000, pooling='max'):
    return _get_model_by_name(path, 'efficientnet-b1', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, pooling=pooling)

def EfficientNetB2(path, include_top=False, input_shape=None, weights='imagenet', classes=1000, pooling='max'):
    return _get_model_by_name(path, 'efficientnet-b2', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, pooling=pooling)

def EfficientNetB3(path, include_top=False, input_shape=None, weights='imagenet', classes=1000, pooling='max'):
    return _get_model_by_name(path, 'efficientnet-b3', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, pooling=pooling)

def EfficientNetB4(path, include_top=False, input_shape=None, weights='imagenet', classes=1000, pooling='max'):
    return _get_model_by_name(path, 'efficientnet-b4', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, pooling=pooling)

def EfficientNetB5(path, include_top=False, input_shape=None, weights='imagenet', classes=1000, pooling='max'):
    return _get_model_by_name(path, 'efficientnet-b5', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, pooling=pooling)

def EfficientNetB6(path, include_top=False, input_shape=None, weights='imagenet', classes=1000, pooling='max'):
    return _get_model_by_name(path, 'efficientnet-b6', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, pooling=pooling)

def EfficientNetB7(path, include_top=False, input_shape=None, weights='imagenet', classes=1000, pooling='max'):
    return _get_model_by_name(path, 'efficientnet-b7', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, pooling=pooling)
